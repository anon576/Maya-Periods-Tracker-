...
class _PartnerDataState extends State<PartnerData> {
  ...
  void getSharedPreference() async {
    ...
    _nameController.text = sp.getString('partnername')!;
    _lastNameController.text = sp.getString('partnerlastname')!;
    _emailController.text = sp.getString('partneremail')!;
    _phoneController.text = sp.getString('partnerphone')!;
    _passwordController.text = sp.getString('password')!;
  }

  Future<void> updatePartner() async {
    try {
      await ApiService.update_partner(
