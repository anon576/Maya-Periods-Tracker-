              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      "What\'s your last month cycle info",
                      style: GoogleFonts.nunitoSans(
                                      ...
                                      if (dateTimeRange != null) {
                                        setState(() {
                                          cycleSelectedDates = dateTimeRange;
                                            ...
                                            sp.setString("cycleStartDate", DateFormat.yMd().format(dateTimeRange.start));
                                            sp.setString(
                                              "cycleEndDate",
                                              DateFormat.yMd()
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (dateTimeRange != null) {
                                        setState(() {
                                          ...
                                          // Store start date in SharedPreferences
                                          sp.setString(
                                              "periodStartDate",
                                              DateFormat.yMd()
                                                  .format(dateTimeRange.start));

                                          // Store end date in SharedPreferences
                                          sp.setString(
                                              "periodEndDate",
                                              DateFormat.yMd()
                                                  .format(dateTimeRange.end));
