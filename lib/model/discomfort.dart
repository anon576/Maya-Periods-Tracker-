...
class _DiscomfortState extends State<Discomfort> {
  String? _selectedMethod; // Make the variable nullable
  int _currentStep = 4;
  ...
  _loadSelectedMethod() async {
    ...
    setState(() {
      _selectedMethod = prefs.getString('discomfortSelectedMethod');
    });
  }

  _saveSelectedMethod(String method) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setString('discomfortSelectedMethod', method);
  }
          ...
          children: [
            ...
            Padding(
              ...
              child: Wrap(
                ...
                children: [
                  _buildMethodOption(
                      'Painful Menstrual cramps', Icons.spa, Colors.red),
                  _buildMethodOption(
                      'PMS Symptoms', Icons.mood_bad, Colors.orange),
                  _buildMethodOption(
                      'Unusual Discharge', Icons.warning, Colors.blue),
                  _buildMethodOption(
                      'Heavy Menstrual flow', Icons.opacity, Colors.purple),
                  _buildMethodOption(
                      'Mood Swings',
                      Icons.sentiment_very_dissatisfied,
                      Colors.yellow),
                  _buildMethodOption(
                      'Others', Icons.more_horiz, Colors.green),
                  _buildMethodOption(
                      ...
                      Navigator.push(
                        ...
                        PageRouteBuilder(
                          ...
                          pageBuilder: (_, __, ___) =>
                              Disorder(), // Replace NextScreen with your desired screen
